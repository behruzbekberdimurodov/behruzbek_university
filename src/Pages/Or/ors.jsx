...
function ors() {
    ...
    function menu_fuf() {
        let functions_mode = document.querySelector(".functions_mode");
        functions_mode.style.display = "flex";
    }
    function close_menu() {
        let functions_mode_close = document.querySelector(".functions_mode");
        functions_mode_close.style.display = "none";
    }
            ...
            </div>
            {
                ...
                <article className="modal-container">
                    <header className="modal-container-header">
                        ...
                        <button   onClick={close_close}  className="icon-button">
                    ...
                    <footer className="modal-container-footer">
                        <button onClick={close_close} className="button is-ghost">Decline</button>
                        <button  onClick={close_close} className="button is-primary">Accept</button>
                    </footer>
                </article>
            </div>
            }
